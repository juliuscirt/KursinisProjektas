...
public class ShopHibernate extends GenericHibernate{
    public ShopHibernate(EntityManagerFactory entityManagerFactory) {super(entityManagerFactory);}
    ...
    public void deleteCart(int id) {
        try {
            ...
            List<Comment> chatList = cart.getChat();
            for(Comment c: chatList){
                Comment chat = entityManager.find(Comment.class, c.getId());
                chat.setOwner(null);
                chat.setChatComment(null);
                chat.getReplies().clear();
